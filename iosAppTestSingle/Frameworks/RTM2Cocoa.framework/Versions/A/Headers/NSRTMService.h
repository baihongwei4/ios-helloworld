...
#import "NSRTMXMLProtocol.h"
#import "NSRTMResponse.h"

@class NSRTMInvoker,JMRMarshaller,JMRMapping,XMLKeyValueElement;
@interface NSRTMService : NSObject <NSRTMXMLProtocol> {
	NSRTMInvoker * invoker;
	NSRTMResponse *mainresponse;
	NSString *valore;
	JMRMarshaller *marshaller;
    JMRMapping *personMapping;
    NSURL *url;
	
    
    XMLKeyValueElement *elt;
}
